...
public class NetworkUtils {
    ...
    private static ConnectivityManager getConnectivityManager() {
        return (ConnectivityManager) getApplication().getSystemService(Context.CONNECTIVITY_SERVICE);
    }
    ...
    private static TelephonyManager getTelephonyManager() {
        return (TelephonyManager) getApplication().getSystemService(Context.TELEPHONY_SERVICE);
    }
    ...
    public static boolean isWifiEnabled(Context context) {
        ...
        TelephonyManager mgrTel = getTelephonyManager();
    ...
    /**
     * 获取连接的网络类型
     * 例如 WIFI, MOBILE, ETHERNET, BLUETOOTH, 等.
     */
